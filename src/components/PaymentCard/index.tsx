import { Contactless } from '@styled-icons/material-outlined'
  ...
  <S.Wrapper size={size}>
    <S.Container>
      <S.Header>
        ...
        <S.ContactLessWrapper size={size}>
          <Contactless />
        </S.ContactLessWrapper>
      </S.Header>
      <S.Body>
        <S.Number size={size}>{number}</S.Number>
        <S.Valid>
      ...
      <S.Footer>
        ...
        {!!flag && <S.FlagWrapper size={size}>{flag}</S.FlagWrapper>}
      </S.Footer>
    </S.Container>
    <Card />
  </S.Wrapper>
