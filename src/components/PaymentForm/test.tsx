...
describe('<PaymentForm />', () => {
  ...
  it('should call createPayment when rendering and render free if freeGames', async () => {
  ...
  it('should call createPayment when rendering and render error if has any issue', async () => {
